...
var Package = new Schema({
  ...
  , num_dependents: {type: Number, default: 0 } // 0
  ...
  , latest_comment: {type: Date, default: 0 }  // new
  , num_comments: {type: Number, default: 0 }  // new
	, comments: [{
  ...
  , num_versions: {type: Number, default: 1 } //new 
...
var User = new Schema({
  ...
  , most_recent_change: {type: Number, default: 0 }  // new
  , num_maintained_packages: {type: Number, default: 0 }  // new
  , maintains: [{type: Schema.ObjectId, ref: 'Package' }]
  , num_votes_for_maintained_packages: {type: Number, default: 0 } // new
  , num_downloads_for_maintained_packages: {type: Number, default: 0 } // new
